...
DEFAULT_INPUT_PATH = PROJECT_ROOT / "app" / "assets" / "resources" / "sections_index_documents.json"
DEFAULT_DB_PATH = PROJECT_ROOT / "app" / "assets" / "indexes" / "sections_units.sqlite3"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a SQLite vector index for document section blocks."
    )
    parser.add_argument(
        "--input",
        type=Path,
